...
public class CounterChip extends InstanceFactory {
  ...
  public void propagate(InstanceState state) {
    ...
    if (ProtoValue.isEnergized(valueVcc, valueGround)) {
      ...
      state.setPort(7, ProtoValue.UNKNOWN, Breadboard.DELAY);
      state.setPort(8, ProtoValue.UNKNOWN, Breadboard.DELAY);
      state.setPort(9, ProtoValue.UNKNOWN, Breadboard.DELAY);
      state.setPort(10, ProtoValue.UNKNOWN, Breadboard.DELAY);
    }
  }
